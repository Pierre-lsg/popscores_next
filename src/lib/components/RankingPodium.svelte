...
<div class="podium-container">
  <div class="podium-visual">
    {#if top3[1]} <div class="place silver">
    ...
    {#if top3[0]} <div class="place gold">
    ...
    {#if top3[2]} <div class="place bronze">
...
<style>
  .podium-container { width: 100%; padding-top: 2rem; }
  ...
  .name { font-size: 0.8rem; font-weight: bold; margin-top: 5px; text-align: center; }
  .score { font-size: 1.2rem; font-weight: 800; color: var(--primary); }

  /* Hauteurs différentes pour l'effet escalier */
  .gold .bar { height: 100px; background: #FFD700; border: 2px solid #E6C200; }
  .silver .bar { height: 70px; background: #C0C0C0; border: 2px solid #A9A9A9; }
  .bronze .bar { height: 50px; background: #CD7F32; border: 2px solid #B87333; }

  .medal { font-size: 1.5rem; margin-bottom: 5px; }

  .others-list { background: #f9f9f9; border-radius: 12px; padding: 10px; }
  .other-item {
    display: flex;
  ...
  .rank { color: #999; font-weight: bold; width: 25px; }
